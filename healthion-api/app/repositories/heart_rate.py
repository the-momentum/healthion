...
def get_heart_rate_recovery_data(
    db: Session,
    query_params: HeartRateQueryParams,
    ...
    """
    query = db.query(HeartRateRecovery)
...
def get_heart_rate_summary(
    ...
    hr_query = db.query(HeartRateData)
    hr_recovery_query = db.query(HeartRateRecovery)
